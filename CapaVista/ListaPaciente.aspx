<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario.Master" AutoEventWireup="true" CodeBehind="ListaPaciente.aspx.cs" Inherits="CapaVista.ListaPaciente" %>
    ...
    <table class="alt"><asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <tr>
            ...
            <td class="auto-style8" colspan="2">
              <center> <asp:Label ID="Label2" ForeColor="White" runat="server" Text="PACIENTE"></asp:Label> </center>
            </td>
