<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario.Master" AutoEventWireup="true" CodeBehind="ListaEspecialidadMedico.aspx.cs" Inherits="CapaVista.ListaEspecialidadMedico" %>
    ...
    <table class="alt"><asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <tr>
            ...
            <td class="auto-style8" colspan="2">
              <center> <asp:Label ID="Label2" ForeColor="White" runat="server" Text="ESPECIALIDAD_ MÉDICO"></asp:Label> </center>
            </td>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="311px">
