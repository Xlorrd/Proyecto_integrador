<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario.Master" AutoEventWireup="true" CodeBehind="AgregarEspecialidad.aspx.cs" Inherits="CapaVista.AgregarEspecialidad" %>
      ...
      <center><table class="alt" style="width: 775px">
        ...
        <tr>
            ...
            <td class="fa-inverse">
                Especialidad</td>
            <td class="auto-style1">
                <asp:TextBox ID="txt_especialidad" runat="server" Width="324px" CssClass="auto-style9"></asp:TextBox>
            </td>
            <td class="auto-style15"></td>
        </tr>
        <tr>
